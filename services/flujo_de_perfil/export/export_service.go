...
func ExportIDDevice_Service(idbusines int, type_int int, inputmanybusinesses []int) (int, bool, string, []string) {
	...
	if type_int == 2 {
		//Enviamos la variable instanciada al repository
		list_string, error_find = worker_repository.Pg_Find_IDDevice_Many(inputmanybusinesses)
		if error_find != nil {
			return 500, true, "Error interno en el servidor al intentar listar todos los ID de dispostivos, detalle: " + error_find.Error(), list_string
		}
	}
